...
4 A tener en cuenta:
    ...
    * Si segundos o minutos es mayor que 60, se tendrá que hacer las operaciones necesarias para incrementar la magnitud superior por el resultado del módulo de 60, quedándose en segundos o minutos con el resto. Es decir 65 segundos equivale a: 1 minuto y 5 segundos.
...
class Tiempo(var hora: Int){
    ...
    override fun toString(): String {
        return String.format("%02dh %02dm %02ds", this.hora, this.minutos, this.segundos)
    }
